...
public proyecto2() {
	...
	// Agrega el panel de contadores al panel norte
	...
	clickedButton.setEnabled(false); // Deshabilita el botón para evitar que se vuelva a presionar
	xTurn = !xTurn; // Cambiar el turno
	checkForWin(); // Revisa si hay un ganador
	}
	}
	});
	}
